...
public class EditOrderVO {
	...
	public EditOrderVO(String customerID, LocalDate orderDate, LocalDate deliveryDate, String status,
			BigDecimal subtotal, BigDecimal tax, BigDecimal totalAmount, String payment, LocalDateTime updateAt,
			String updateBy, String orderID) {
		super();
