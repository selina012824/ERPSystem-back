...
@IdClass(value = OrderInfoID.class)
public class OrderInfo {
	...
	public OrderInfo(String orderDetailID, String orderID, String materialID, String processingType, int quantity,
			BigDecimal unitPrice, BigDecimal subtotal, BigDecimal thickness, BigDecimal width, BigDecimal length,
			BigDecimal weight, BigDecimal diameter, BigDecimal outerDiameter, BigDecimal innerThickness,
			BigDecimal cuttingSize, String surfaceTreatment, String specification, LocalDateTime createAt,
			String createClerkNm, LocalDateTime updateAt, String updateBy) {
		super();
