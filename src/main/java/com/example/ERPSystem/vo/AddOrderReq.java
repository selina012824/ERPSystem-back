...
public class AddOrderReq {
	...
	public AddOrderReq(String orderID, String estScrapID, String customerID, LocalDate orderDate,
			LocalDate deliveryDate, String status, BigDecimal subtotal, BigDecimal tax, BigDecimal totalAmount,
			String payment, LocalDateTime createAt, String createBy, LocalDateTime updateAt, String updateBy,
